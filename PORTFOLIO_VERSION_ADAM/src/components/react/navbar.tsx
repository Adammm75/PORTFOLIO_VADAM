      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 p-6">
          ...
          >
            ...
            <span className={
              'transition-opacity duration-200 ease-in-out text-white font-bold'}>
              {SITE.title}
            </span>
          </Link>
                  ...
                  >
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive 
                          ? "text-white after:w-full after:bg-yellow-400 font-bold" 
                          : "text-white/90"
                      )}
                ...
                {NAV_LINKS.map((item, i) => (
                  ...
                  >
                    <Link
                      ...
                      className="text-white text-lg font-bold font-custom capitalize hover:text-white transition-colors inline-block py-2 relative group"
                    >
                      {item.label}
